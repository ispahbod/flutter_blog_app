...
import 'package:flutter_blog_app/pages/auth_page.dart';
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  if (page == boards.length - 1) {
                                    Navigator.of(context).pushReplacement(CupertinoPageRoute(builder: (builder) => const AuthScreen()));
                                  } else {
                                    _pageController.animateToPage(page + 1, duration: const Duration(milliseconds: 500), curve: Curves.decelerate);
                                  }
                                },
                                style: ButtonStyle(
                                  minimumSize: MaterialStateProperty.all(const Size(90, 60)),
